...
namespace BinarySearchTests
{
    public class RecursionBinarySearchTests
    {
        ...
        {
            // Act
            var result = BinarySearch.RecursiveBinarySearch.Search(_arr, 0, _arr.Length - 1, value);
        ...
        {
            // Act
            var result = BinarySearch.RecursiveBinarySearch.Search(_arr, 0, _arr.Length - 1, 100);
